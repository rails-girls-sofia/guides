...
- Брандирани и индивидуализирани неща (чаши, чанти, тениски...)
...
>
> Ако решите да идвате и не сте ходили преди в Init Lab, ще има една среща на този изход на метростанция "Лъвов мост" в 19:15 (карта). Ако закъснявате, или не се ориентирате, може да звъннете на TODO (TODO).
>
> ## Ресурси
>
