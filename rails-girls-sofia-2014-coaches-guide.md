...
След инсталацията ще преминем към играта "How to train a robot". Ще се движим доста плътно по [обяснителния блог пост на Ира](http://dira.ro/2013/04/29/the-robot-game-at-railsgirls-krakow) прочетете го внимателно.
...
Целта е участничките да усетят болката от повторение на команди, за да могат да стигнат естествено до нуждата от абстракция - функция. Тя се вкарва на следващ етап, след няколко опита за писане-изключение-дебъг-писане-изключение-дебъг.
...
### Кафе и регистрация за новодошлите (09:00 - 10:00)

Участниците започват да се събират от 9 ч. Ще има кафе и кексчета, плодове или нещо подобно. В 10 ч. е началото на съботния ден.
...
След обяда ще направим [Bentobox упражнението (видео)](https://vimeo.com/39049632). Целта му е да покаже на учсатниците как да се ориентират в морето от термини и специфичен жаргон.
...
Към момента имаме следните теми:
