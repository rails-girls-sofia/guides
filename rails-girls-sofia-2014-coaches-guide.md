...
Когато се работи под Windows е добре да се настрои Command Prompt-a да бъде малко по-приветлив. [Тук](http://www.akitaonrails.com/2009/01/13/the-best-environment-for-rails-on-windows#.UxZDufmSySp) има обяснение как това може да стане (в секция Personalizing you command prompt).
