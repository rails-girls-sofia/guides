...
Вместо да се инсталира необходимият за разработка софтуер, ще ползваме cloud-базираната среда [Cloud9](https://c9.io).
...
Необходимо е всяка от участничките ви да има акаунт в Cloud9 и в него да е създаден Ruby workspace (проект). Регистрацията е безплатана и става бързо, но изисква данни за плащане. Поради тази причина, имаме специално създаден [education профил](https://c9.io/team/new?plan=School) Rails Girls Sofia Team, през който можем да каним неограничен брой "ученици". Би трябвало всяка участничка и всеки инструктор да е получил покана на имейла си до Cloud9 през този наш акаунт преди самото събитие. Ако писмо с покана не се намира (дори и в "спам"), потърсете някой от екипа ни, за да изпрати покана.
...
Ако забележите интерес у участничките ви, в края на събитието може да ги насочите и към [Sublime Text](http://www.sublimetext.com) или [Atom](https://atom.io/) и да им съдействате да си инсталират един от двата.
