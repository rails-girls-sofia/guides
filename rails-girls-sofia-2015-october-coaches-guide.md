...
- Логнете се в [Nitrous.io](http://nitrous.io) и го разцъкайте. Създайте Ruby on Rails контейнер и workspace.
...
Начало - събота, след събитието. Вероятно от около 20 ч. Цел - социализация, особено между участниците, за да помогне за създаването на общност.

Възможно е да е в Ink Bar, до спортната палата. Мястото ще стане ясно няколко дни преди събитието.
